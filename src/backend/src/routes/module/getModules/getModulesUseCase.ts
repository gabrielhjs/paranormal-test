...
export class GetModulesUseCase implements IUseCase<GetModuleDto, Question[]> {
  constructor(
    private questionRepository: IQuestionRepository
  ) { }
  async execute(_: GetModuleDto): Promise<IUseCaseResponse<Question[]>> {
    ...
    return {
      error: false,
      data: await this.questionRepository.getAllQuestions()
    }
  }
}